...
[G, split1_lower_curve] = add_paths(G, split1,-0.505, 43);
...
[G, joining_1] = add_split(G, path1_lower_next,0);
G = addedge(G, joining_1, plower_2Upper);
% There p63
G = addedge(G, 'P63',split1_lower_curve);

% Continue upper then split
[G, continue_lower] = add_paths(G, joining_1, 0.125, 5);
[G, lowersplit] = add_split(G, continue_lower,0);

[G, final_leg_1] = add_paths(G, lowersplit, -0.2, 30);
[G, final_leg_2] = add_paths(G, lowersplit, 0.5, 40);
