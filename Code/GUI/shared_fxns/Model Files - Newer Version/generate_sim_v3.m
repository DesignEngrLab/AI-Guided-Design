...
[G, P1B11o2] = add_paths(G, P1B11b,-1.9,10);
...
[G, P1Co1] = add_paths(G, P1C, -1, 8);
[G, P1Co1c] = add_paths(G, P1Co1, 1, 8);
...
[G, P1Co3] = add_paths(G, P1Cc2, 1.5, 8);
[G, P1Co3c] = add_paths(G, P1Co3, -1.5, 4);
...
G = addedge(G, P1B2,P1Cc5);

[G, P1Cc6a] = add_paths(G, P1Cc5, 0.85, 14);


[G, P1Cc6b] = add_paths(G, P1Cc5, -1.5, 15);
[G, P1Cc6b1] = add_paths(G,  P1Cc6b, 1.5, 10);
[G, P1Cc6b2] = add_paths(G,  P1Cc6b, -1, 5);

G = addedge(G,P1B11o2, P1Cc6a);

% I'm loosing track
G = update_angle(G, P1Cc4, -0.5);
[G, P1CcA] = add_paths(G, P1Cc4, -1.75, 5);

G = update_angle(G, P1Co2c, -0.5);
[G, P1Co2c1] = add_paths(G, P1Co2c, 0.8, 15);
[G, P1Co2c2] = add_paths(G, P1Co2c1, 0.8, 10);
[G, P1Co2c2] = add_paths(G, P1Co2c1, -0.8, 10);
...
for i = 1:numnodes(G)
    ...
    % If it's
    if strcmp(G.Nodes.Type{i},'Path') & rand < 0.475
...
%
for i = 1:numnodes(G)
    G.Nodes.Pos{i}(2) =40-G.Nodes.Pos{i}(2);
